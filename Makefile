...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.36
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.36
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.36
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.36
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.36
