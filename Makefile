...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.35
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.36
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.34
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.36
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.34
