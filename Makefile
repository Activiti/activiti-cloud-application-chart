...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.11
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.11
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.11
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.11
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.11
