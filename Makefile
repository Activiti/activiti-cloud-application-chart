...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.29
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.30
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.30
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.29
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.29
