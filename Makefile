...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.27
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.28
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.28
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.28
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.27
