...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.61
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.62
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.62
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.61
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.61
