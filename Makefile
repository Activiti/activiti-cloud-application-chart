...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.65
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.65
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.65
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.65
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.65
