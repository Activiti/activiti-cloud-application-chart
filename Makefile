...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.37
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.37
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.38
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.37
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.37
