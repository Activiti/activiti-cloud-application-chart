...
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.2
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.2
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.3
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.2
