...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.52
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.52
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.51
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.52
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.52
