...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.34
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.34
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.34
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.34
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.33
