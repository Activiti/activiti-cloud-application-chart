...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.64
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.64
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.65
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.64
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.64
