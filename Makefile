...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.48
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.48
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.49
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.47
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.48
