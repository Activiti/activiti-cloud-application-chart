...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.31
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.31
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.32
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.31
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.31
