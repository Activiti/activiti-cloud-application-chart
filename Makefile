...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.55
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.56
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.55
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.55
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.55
