...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.45
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.45
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.45
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.45
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.44
