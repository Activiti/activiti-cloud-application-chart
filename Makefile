...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.16
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.16
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.16
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.16
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.16
