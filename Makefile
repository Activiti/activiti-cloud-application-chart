...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.60
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.60
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.61
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.61
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.60
