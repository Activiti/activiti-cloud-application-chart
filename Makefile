...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.66
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.67
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.65
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.66
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.66
