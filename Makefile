...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.42
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.41
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.40
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.42
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.40
