...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.17
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.18
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.17
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.18
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.18
