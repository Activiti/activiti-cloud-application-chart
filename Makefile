...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.25
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.26
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.25
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.25
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.25
