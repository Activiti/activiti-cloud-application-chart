...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.67
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.67
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.68
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.67
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.67
