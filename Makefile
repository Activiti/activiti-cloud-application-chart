...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.14
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.15
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.15
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.15
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.14
