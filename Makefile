...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.43
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.43
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.44
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.43
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.43
