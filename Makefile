...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.49
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.50
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.50
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.50
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.49
