...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.20
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.20
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.20
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.21
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.20
