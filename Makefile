...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.63
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.64
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.64
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.63
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.63
