...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.3
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.3
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.3
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.4
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.3
