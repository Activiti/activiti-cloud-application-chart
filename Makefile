...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.24
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.24
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.23
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.23
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.24
