...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.2
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.1
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.1
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.2
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.1
