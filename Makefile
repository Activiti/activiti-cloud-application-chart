...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.57
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.58
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.58
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.57
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.56
