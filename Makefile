...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.6
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.5
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.5
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.6
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.6
