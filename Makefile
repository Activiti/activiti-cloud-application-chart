...
QUERY_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.46
AUDIT_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.47
CONNECTOR_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.47
RB_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.47
NOTIFICATIONS_ACTIVITI_CLOUD_DEPENDENCIES_VERSION := 7.1.46
